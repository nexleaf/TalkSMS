...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SerializedTask.s_session_id'
        db.delete_column('taskmanager_serializedtask', 's_session_id_id')

        # Adding field 'SerializedTask.s_session'
        db.add_column('taskmanager_serializedtask', 's_session', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['taskmanager.Session']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SerializedTask.s_session_id'
        db.add_column('taskmanager_serializedtask', 's_session_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['taskmanager.Session']), keep_default=False)

        # Deleting field 'SerializedTask.s_session'
        db.delete_column('taskmanager_serializedtask', 's_session_id')
