...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnmatchedMessages'
        db.create_table('taskmanager_unmatchedmessages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identity', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('message_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('message_text', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('taskmanager', ['UnmatchedMessages'])


    def backwards(self, orm):
        
        # Deleting model 'UnmatchedMessages'
        db.delete_table('taskmanager_unmatchedmessages')
    ...
    models = {
        ...
        'taskmanager.task': {
            ...
            'templates': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['dbtemplates.Template']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'taskmanager.unmatchedmessages': {
            'Meta': {'ordering': "['-message_datetime']", 'object_name': 'UnmatchedMessages'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identity': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'message_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
