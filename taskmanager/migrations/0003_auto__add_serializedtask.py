...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('taskmanager_serializedtask', (
            ...
            ('s_session_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taskmanager.Session'])),
    ...
    models = {
        ...
        'taskmanager.serializedtask': {
            ...
            's_session_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['taskmanager.Session']"}),
